...
class SlidingWindow {
    ...
    public static int findSubArrayWithLeastAverage(int[] A, int B) {
        ...
        /*
         * Problem Description: Given an array A of size N, find the subarray of size B
        ...
        for (int j = B; j < arrLength; j++) {
            ...
            // Here I didn't calculate average because if the sum is minimum there obviously
            // the average will also be min.
            sum = sum + A[j] - A[j - B];
            if (sum < minSum) {
                minSum = sum;
                minIndex = j - B + 1;
    ...
    public static void totalSumOfAllPossibleSubarrays(int[] A) {
        ...
        System.out.println("Prefix Sum Result: " + pfResult);
        // time - N + N2 = O(N2) - Space - O(n)
        // ----
        ...
        System.out.println("Carry forward result: " + cfResult);
    ...
    public static void main(String[] args) {
        ...
        // int B1 = 3;
        // System.out.println("findSubArrayWithLeastAverage: " +
        // findSubArrayWithLeastAverage(A1, B1));

        // System.out.println("countGoodSubarrays: " + countGoodSubarrays(A1, B1)); //
        // Expected: 6
